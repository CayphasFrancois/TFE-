...
class CriticNetwork (nn.Module) : # objectif du critic : estimer Q
    def __init__ (self,beta,input_dims,fc1_dims,fc2_dims,n_actions,name,chkpt_dir='C:/TFE-Code/TFE_Grid2Op/checkpoint_TD3_TFE'):
        ...
        self.action_value = nn.Linear(self.n_actions , fc2_dims) # projection de l'action dans le même espace que fc2
        f3 = 0.003
        ...
        self.fc5 = nn.Linear(self.fc1_dims, self.fc2_dims)
        ...
        self.action_value2 = nn.Linear(self.n_actions , fc2_dims) # projection de l'action dans le même espace que fc2
        f3 = 0.003
